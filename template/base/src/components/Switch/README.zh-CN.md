...
```html
<MySwitch v-model="checked" disabled />
```
...
```html
<MySwitch v-model="checked" loading />
```
...
```html
<MySwitch v-model="checked" size="24px" />
```
...
```html
<MySwitch v-model="checked" active-color="#ee0a24" inactive-color="#dcdee0" />
```
...
```html
<MySwitch :value="checked" @input="onInput" />
```
